...
export class BellatrixExecutionPayload {
  static encode(message: BellatrixExecutionPayload, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): BellatrixExecutionPayload {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new BellatrixExecutionPayload();
