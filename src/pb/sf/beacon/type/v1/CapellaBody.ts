...
import { CapellaExecutionPayload } from "./CapellaExecutionPayload";

export class CapellaBody {
  static encode(message: CapellaBody, writer: Writer): void {
    writer.uint32(10);
    ...
    if (executionPayload !== null) {
      writer.uint32(82);
      writer.fork();
      CapellaExecutionPayload.encode(executionPayload, writer);
      writer.ldelim();
    }
  }

  static decode(reader: Reader, length: i32): CapellaBody {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new CapellaBody();
    ...
    while (reader.ptr < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 10:
          message.executionPayload = CapellaExecutionPayload.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  executionPayload: CapellaExecutionPayload | null;
  ...
  constructor(
    ...
    executionPayload: CapellaExecutionPayload | null = null
  ) {
