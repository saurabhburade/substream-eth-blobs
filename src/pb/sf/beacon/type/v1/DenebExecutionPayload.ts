...
export class DenebExecutionPayload {
  static encode(message: DenebExecutionPayload, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): DenebExecutionPayload {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new DenebExecutionPayload();
