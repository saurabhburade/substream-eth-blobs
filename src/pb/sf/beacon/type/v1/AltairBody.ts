...
export class AltairBody {
  static encode(message: AltairBody, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): AltairBody {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new AltairBody();
