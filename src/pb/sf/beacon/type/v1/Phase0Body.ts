...
export class Phase0Body {
  static encode(message: Phase0Body, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Phase0Body {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Phase0Body();
